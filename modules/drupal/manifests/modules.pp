...
class drupal::modules {
      ...
      $drupal_site_root_path = "/home/vagrant/drupal"
      ...
      module {"og": file=>"og-7.x-2.0-beta2.tar.gz"}
      module {"og_views": file=>"og_views-7.x-1.0.tar.gz"}
      module {"panels": file=>"panels-7.x-3.3.tar.gz"}
      module {"entity": file=>"entity-7.x-1.0-rc3.tar.gz"}
      module {"views": file=>"views-7.x-3.5.tar.gz"}
      module {"ctools": file=>"ctools-7.x-1.2.tar.gz"}
      module {"features": file=>"features-7.x-1.0.tar.gz"}
      module {"role_export": file=>"role_export-7.x-1.0.tar.gz"}
      module {"services": file=>"services-7.x-3.2.tar.gz"}
      ...
      module {"wysiwyg": file=>"wysiwyg-7.x-2.2.tar.gz"}
      ...
      module {"media_derivatives": file=>"media_derivatives-7.x-1.0-beta1.tar.gz"}
      ...
      $ckeditor = "ckeditor"
      $ckeditor_file = "ckeditor_3.6.5.tar.gz"
      library { "$ckeditor":
